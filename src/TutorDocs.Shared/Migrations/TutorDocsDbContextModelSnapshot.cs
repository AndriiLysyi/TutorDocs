...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TutorDocs.Shared.Models.Entities.AccessControlList", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TutorDocs.Shared.Models.Entities.Document", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TutorDocs.Shared.Models.Entities.DocumentChunk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TutorDocs.Shared.Models.Entities.DocumentOwner", b =>
                {
                    b.Property<Guid>("DocumentId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TutorDocs.Shared.Models.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TutorDocs.Shared.Models.Entities.AccessControlList", b =>
                {
                    b.HasOne("TutorDocs.Shared.Models.Entities.Document", "Document")
                        .WithMany("SharedWith")
                        .HasForeignKey("DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TutorDocs.Shared.Models.Entities.User", "User")
